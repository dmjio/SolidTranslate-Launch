<apply template="base">
  <!-- Title -->
  <bind tag="titletag">Thank You!</bind>
  <!-- Styles -->
  <bind tag="styles">
  ...
  <bind tag="bodyContent">
    <div class="container">
      <div class="text-center jumbotron" style="height: 362px">
          ...
          <p style="font-size: 34px;font-weight: 200;color:DarkGreen">Thanks for signing
          up! <br />
          We will keep you informed of the latest updates.</p>
          <a class="btn btn-lg btn-success" href="/">Go Home</a>
      </div>
    </div>
